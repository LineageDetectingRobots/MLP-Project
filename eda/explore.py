...
# train_images_df = pd.datasetsFrame({
#     'files': files,
...
# print("Total number of members in the datasetsset: {0}".format(train_images_df["uniqueId"].nunique()))
# print("Total number of families in the datasetsset: {0}".format(train_images_df["familyId"].nunique()))
...
# datasets = [trace]
# fig = go.Figure(datasets=datasets, layout=layout)
...
for n1, attr in g.nodes(datasets=True):
    if attr['type'] == 'fam':
